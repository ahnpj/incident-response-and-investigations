...
|--------|--------|------------------|
| Windows Security Event | Event ID 4720 — user account created | Confirms creation of a new local account on the system |
...
| Field | Value | Investigative Use |
|--------|--------|------------------|
| Process Creation Telemetry | Windows Security Event ID 4688 | Confirms execution of remote management command |
| Executed Binary | `WMIC.exe` | Indicates use of built-in tool for remote execution |
...
| Field | Value | Investigative Use |
|--------|--------|------------------|
| Sysmon Registry Event | Event ID 12 — registry object created | Indicates modification of sensitive registry location |
...
| Field | Value | Investigative Use |
|--------|--------|------------------|
| Decoded Script Content | Extracted PowerShell payload | Allows inspection of attacker intent |
| Extracted URL | `http://10.10.10.5/news.php` | Identifies external resource contacted by script |
| Defanged IOC | `hxxp[://]10[.]10[.]10[.]5/news[.]php` | Safe format for reporting and sharing indicator |
